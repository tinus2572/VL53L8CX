...
pub(crate) const VL53L8CX_STATUS_OK: u8 = 0;
pub(crate) const VL53L8CX_STATUS_TIMEOUT_ERROR: u8 = 1;
pub(crate) const VL53L8CX_STATUS_CORRUPTED_FRAME: u8 = 2;
pub(crate) const VL53L8CX_STATUS_LASER_SAFETY: u8 = 3;
pub(crate) const VL53L8CX_MCU_ERROR: u8 = 66;
pub(crate) const VL53L8CX_STATUS_INVALID_PARAM: u8 = 127;
pub(crate) const VL53L8CX_STATUS_ERROR: u8 = 255;

// Definitions for Range results block headers
pub(crate) const VL53L8CX_START_BH: u32 = if VL53L8CX_NB_TARGET_PER_ZONE == 1 { 0x0000000D } else { 0x0000000D };
pub(crate) const VL53L8CX_METADATA_BH: u32 = if VL53L8CX_NB_TARGET_PER_ZONE == 1 { 0x54B400C0 } else { 0x54B400C0 };
pub(crate) const VL53L8CX_COMMONDATA_BH: u32 = if VL53L8CX_NB_TARGET_PER_ZONE == 1 { 0x54C00040 } else { 0x54C00040 };
pub(crate) const VL53L8CX_AMBIENT_RATE_BH: u32 = if VL53L8CX_NB_TARGET_PER_ZONE == 1 { 0x54D00104 } else { 0x54D00104 };
pub(crate) const VL53L8CX_SPAD_COUNT_BH: u32 = if VL53L8CX_NB_TARGET_PER_ZONE == 1 { 0x55D00404 } else { 0x57D00401 };
pub(crate) const VL53L8CX_NB_TARGET_DETECTED_BH: u32 = if VL53L8CX_NB_TARGET_PER_ZONE == 1 { 0xDB840401 } else { 0x55D00404 };
pub(crate) const VL53L8CX_SIGNAL_RATE_BH: u32 = if VL53L8CX_NB_TARGET_PER_ZONE == 1 { 0xDBC40404 } else { 0x58900404 };
pub(crate) const VL53L8CX_RANGE_SIGMA_MM_BH: u32 = if VL53L8CX_NB_TARGET_PER_ZONE == 1 { 0xDEC40402 } else { 0x64900402 };
pub(crate) const VL53L8CX_DISTANCE_BH: u32 = if VL53L8CX_NB_TARGET_PER_ZONE == 1 { 0xDF440402 } else { 0x66900402 };
pub(crate) const VL53L8CX_REFLECTANCE_BH: u32 = if VL53L8CX_NB_TARGET_PER_ZONE == 1 { 0xE0440401 } else { 0x6A900401 };
pub(crate) const VL53L8CX_TARGET_STATUS_BH: u32 = if VL53L8CX_NB_TARGET_PER_ZONE == 1 { 0xE0840401 } else { 0x6B900401 };
pub(crate) const VL53L8CX_MOTION_DETECT_BH: u32 = if VL53L8CX_NB_TARGET_PER_ZONE == 1 { 0xD85808C0 } else { 0xCC5008C0 };

pub(crate) const VL53L8CX_METADATA_IDX: u16 = if VL53L8CX_NB_TARGET_PER_ZONE == 1 { 0x54B4 } else { 0x54B4 };
pub(crate) const VL53L8CX_SPAD_COUNT_IDX: u16 = if VL53L8CX_NB_TARGET_PER_ZONE == 1 { 0x55D0 } else { 0x55D0 };
pub(crate) const VL53L8CX_AMBIENT_RATE_IDX: u16 = if VL53L8CX_NB_TARGET_PER_ZONE == 1 { 0x54D0 } else { 0x54D0 };
pub(crate) const VL53L8CX_NB_TARGET_DETECTED_IDX: u16 = if VL53L8CX_NB_TARGET_PER_ZONE == 1 { 0xDB84 } else { 0x57D0 };
pub(crate) const VL53L8CX_SIGNAL_RATE_IDX: u16 = if VL53L8CX_NB_TARGET_PER_ZONE == 1 { 0xDBC4 } else { 0x5890 };
pub(crate) const VL53L8CX_RANGE_SIGMA_MM_IDX: u16 = if VL53L8CX_NB_TARGET_PER_ZONE == 1 { 0xDEC4 } else { 0x6490 };
pub(crate) const VL53L8CX_DISTANCE_IDX: u16 = if VL53L8CX_NB_TARGET_PER_ZONE == 1 { 0xDF44 } else { 0x6690 };
pub(crate) const VL53L8CX_REFLECTANCE_EST_PC_IDX: u16 = if VL53L8CX_NB_TARGET_PER_ZONE == 1 { 0xE044 } else { 0x6A90 };
pub(crate) const VL53L8CX_TARGET_STATUS_IDX: u16 = if VL53L8CX_NB_TARGET_PER_ZONE == 1 { 0xE084 } else { 0x6B90 };
pub(crate) const VL53L8CX_MOTION_DETEC_IDX: u16 = if VL53L8CX_NB_TARGET_PER_ZONE == 1 { 0xD858 } else { 0xCC50 };

pub(crate) const VL53L8CX_NVM_DATA_SIZE: usize = 492;
pub(crate) const VL53L8CX_CONFIGURATION_SIZE: usize = 972;
pub(crate) const VL53L8CX_OFFSET_BUFFER_SIZE: usize = 488;
pub(crate) const VL53L8CX_XTALK_BUFFER_SIZE: usize = 776;
...
pub(crate) const VL53L8CX_DCI_FREQ_HZ: u16 = 0x5458;
pub(crate) const VL53L8CX_DCI_INT_TIME: u16 = 0x545C;
pub(crate) const VL53L8CX_DCI_RANGING_MODE: u16 = 0xAD30;
pub(crate) const VL53L8CX_DCI_DSS_CONFIG: u16 = 0xAD38;
pub(crate) const VL53L8CX_DCI_VHV_CONFIG: u16 = 0xAD60;
pub(crate) const VL53L8CX_DCI_TARGET_ORDER: u16 = 0xAE64;
pub(crate) const VL53L8CX_DCI_SHARPENER: u16 = 0xAED8;
pub(crate) const VL53L8CX_DCI_SYNC_PIN: u16 = 0xB5F0;
pub(crate) const VL53L8CX_DCI_INTERNAL_CP: u16 = 0xB39C;
pub(crate) const VL53L8CX_DCI_MOTION_DETECTOR_CFG: u16 = 0xBFAC;
pub(crate) const VL53L8CX_DCI_ZONE_CONFIG: u16 = 0x5450;
pub(crate) const VL53L8CX_DCI_FW_NB_TARGET: u16 = 0x5478;
pub(crate) const VL53L8CX_DCI_SINGLE_RANGE: u16 = 0xD964;
pub(crate) const VL53L8CX_DCI_OUTPUT_CONFIG: u16 = 0xD968;
pub(crate) const VL53L8CX_DCI_OUTPUT_ENABLES: u16 = 0xD970;
pub(crate) const VL53L8CX_DCI_OUTPUT_LIST: u16 = 0xD980;
pub(crate) const VL53L8CX_DCI_PIPE_CONTROL: u16 = 0xDB80;

pub(crate) const VL53L8CX_UI_CMD_STATUS: u16 = 0x2C00;
pub(crate) const VL53L8CX_UI_CMD_START: u16 = 0x2C04;
pub(crate) const VL53L8CX_UI_CMD_END: u16 = 0x2FFF;
...
pub(crate) const VL53L8CX_USE_RAW_FORMAT: u8 = 0;
...
// Inner Macro for API. Not for user, only for development.
pub(crate) const VL53L8CX_DCI_DET_THRESH_CONFIG: u16 = 0x5488;
pub(crate) const VL53L8CX_DCI_DET_THRESH_GLOBAL_CONFIG: u16 = 0xB6E0;
pub(crate) const VL53L8CX_DCI_DET_THRESH_START: u16 = 0xB6E8;
pub(crate) const VL53L8CX_DCI_DET_THRESH_VALID_STATUS: u16 = 0xB9F0;
...
pub(crate) const VL53L8CX_DCI_CAL_CFG: u16 = 0x5470;
pub(crate) const VL53L8CX_DCI_XTALK_CFG: u16 = 0xAD94;
